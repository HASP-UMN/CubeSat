...
q = 1;
for i = 9:65
    clyinder_data_run1(q) = rms(velocity_data(i,1:1000));
...
q = 1;
for i = 66:124
    clyinder_data_run3(q) = rms(velocity_data(i,1:1000));
...
q = 1;
for i = 125:142
    AOA_0_data(q) = rms(velocity_data(i,1:1000));
...
q = 1;
for i = 145:166
    AOA_5_data(q) = rms(velocity_data(i,1:1000));
...
q = 1;
for i = 168:177
    AOA_10_data(q) = rms(velocity_data(i,1:1000));
...
q = 1;
for i = 182:252
    AOA_17_data(q) = rms(velocity_data(i,1:1000));
