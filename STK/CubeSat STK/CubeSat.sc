...
BEGIN Animation
    ...
    EndTime            4 Dec 2015 18:00:00.000000000
    CurrentTime        4 Dec 2015 05:25:01.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       -0.656934
            CenterLongitude      30.763636
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\Jake\Documents\STK 10\CubeSat
            BaseName         Frame
            Digits           4
            Frame            0
        ...
        BEGIN Defaults
            BEGIN Catalog Spacecraft
                BEGIN Criteria Name or ID
                    ...
                    Value CubeSat
                END Criteria
                BEGIN Criteria Launch Date
                    Type  Min
                    Min   1957-10-04
                END Criteria
                BEGIN Criteria Periapsis Altitude
                    Type  MinMax
                    Min   410 km
                    Max   99999 km
                END Criteria
                ...
                BEGIN Criteria Operational Status
                    Type  Value
                    Value Backup or Standby
                END Criteria
                BEGIN Criteria Object Extension
                    Type  List
                    Value Transmitter
                END Criteria
            END Catalog
...
BEGIN References
    Instance *
        *
    END Instance
    Instance AreaTarget/AnchorageAK
        AreaTarget/AnchorageAK
    END Instance
    Instance AreaTarget/AreaTarget1
        AreaTarget/AreaTarget1
    END Instance
    Instance AreaTarget/BoulderCO
        AreaTarget/BoulderCO
    END Instance
    Instance AreaTarget/CroostonMN
        AreaTarget/CroostonMN
    END Instance
    Instance AreaTarget/HonoluluHI
        AreaTarget/HonoluluHI
    END Instance
    Instance Satellite/CubeSat
        Satellite/CubeSat
    END Instance
    Instance Satellite/Iss_25544
        Satellite/Iss_25544
    END Instance
    Instance Satellite/WeWish_38856
        Satellite/WeWish_38856
    END Instance
END References
