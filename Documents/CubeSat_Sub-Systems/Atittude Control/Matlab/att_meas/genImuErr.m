...
%                                                                                       %
%   (2) gps = (nx10) = [   t    psi  theta  phi   Vn    Ve    Vd    X   Y   Z   ];      %
%                      [ (sec) (rad) (rad) (rad) (m/s) (m/s) (m/s) (m) (m) (m)];        %                                                                %
%=======================================================================================%

loadpath = 'D:\USERS\scratch\';
...
eval(['save ',loadpath,'uav_imu_data.mat imu_corrupt H_corrupt sensorError -append']);
eval(['save ',loadpath,'uav_imu_data.mat Kg Ka INSQualFlag tau_f tau_g -append']);
eval(['save ',loadpath,'uav_imu_data.mat sigma_c_g sigma_w_g sigma_c_f sigma_w_f -append']);     
