...
psi_m = 90;           f_psi_1 = 1.1e-3;     w_psi_o = pi/2;
the_m = 0;            f_the_1 = 1.1e-5;     w_the_o = 0;
phi_m = 0;            f_phi_1 = 1.1e-5;     w_phi_o = pi/4;

psi = psi_m*sin(2*pi*f_psi_1*t + w_psi_o);
...
Vn_m = 250;       f_Vn_1 = 1e-15;       w_Vn_o = pi/2;
...
psi_dot = (psi_m*(2*pi*f_psi_1))*(cos(2*pi*f_psi_1*t + w_psi_o));
...
pe = phi_dot + - st.*psi_dot;
qe = cp.*the_dot + (ct.*sp).*psi_dot;
re = -sp.*the_dot + (ct.*cp).*psi_dot;
